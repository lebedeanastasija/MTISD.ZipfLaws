...
from InverseFrequency import InverseFrequency


class WeightsMethod:
    def __init__(self, texts, low_weight):
        self.words_matrix = []
        ...
        for text in texts:
            text_words = TextHelper.filter_words(TextHelper.get_words(text))
    ...
    def calc_inverse_frequencies(self):
        ...
        # Print inverse frequency of all words in all texts
        # for inv_freq in self.word_inverse_frequencies:
        #     print('[{}], lambda_i={}, texts numbers={}'.format(
        #         inv_freq.word, inv_freq.get_inverse_frequency(), inv_freq.texts
        #     ))
